...
namespace test
{
	...
	public:
		...
		{
			m_engine.OnStart += event::Handler(this, &TestPinchBlock::OnStart);
			m_engine.OnUpdate += event::Handler(this, &TestPinchBlock::OnUpdate);
			m_engine.OnRender += event::Handler(this, &TestPinchBlock::OnRender);
			m_engine.OnResize += event::Handler(this, &TestPinchBlock::OnResize);

			input::Input::Instance().OnKeyDown += event::Handler(this, &TestPinchBlock::OnKeyDown);
			input::Input::Instance().OnMouseDown += event::Handler(this, &TestPinchBlock::OnMouseDown);
			input::Input::Instance().OnMouseMove += event::Handler(this, &TestPinchBlock::OnMouseMove);
			input::Input::Instance().OnMouseUp += event::Handler(this, &TestPinchBlock::OnMouseUp);
