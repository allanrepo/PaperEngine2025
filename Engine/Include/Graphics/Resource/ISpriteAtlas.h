	...
	namespace graphics
	{
		...
		namespace resource
		{
			...
			public:
				...
				virtual void AddUVRect(const engine::math::RectF& rect) = 0;
				virtual void AddUVRects(const std::vector<engine::math::RectF>& rects) = 0;
				virtual inline const engine::math::RectF GetUVRect(int index) const = 0;
