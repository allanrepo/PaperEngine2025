...
namespace engine::graphics
{
	...
	namespace resource
	{
		...
		private:
			...
			std::vector<engine::math::RectF> m_nUVs;
		...
		public:
			...
			virtual void AddUVRect(const engine::math::RectF& rect) override final;
			virtual void AddUVRects(const std::vector<engine::math::RectF>& rects) override final;
			virtual const inline engine::math::RectF GetUVRect(int index) const override final;
			virtual inline size_t GetUVRectCount() const override final;
			virtual engine::graphics::Sprite MakeSprite(int index, const engine::spatial::PositionF& pivot = {0,0}) const override final;
