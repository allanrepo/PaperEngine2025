...
#pragma region // friends
			// it is friend of UISystem because it needs to access UISystem's protected methods to register and unregister itself to the system.
			// UISystem also needs access to Widget's input handlers, drag and hit test handlers, and UI tree traversal methods, which are protected. 
			friend class UISystem;

			// it is friend of Widget because it needs to access Widget's tooltip builder function. 
			// as friend, it allows Widget to not expose its tooltip builder function to the public, while still allowing TooltipManager to access it.
...
#pragma region // tooltip manager access for building tooltip
