...
#pragma region // update vertex translate transform. this will be the position. 
	...
	m_UpdateConstantBuffer.vertex.translate.x = (-m_D3DViewPort.Width + size.width) / 2 + pos.x - anchor.x;
	m_UpdateConstantBuffer.vertex.translate.y = (m_D3DViewPort.Height - size.height) / 2 + -pos.y + anchor.y;
#pragma endregion
